...
get_header(); ?>
    ...
    <section class="video-reviews">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3><?php the_field('main_title_video_reviews_page'); ?></h3>
                </div>
                <!-- /.col-md-12 -->
            </div>
            <!-- /.row -->
            <div class="row video-list">
                ...
                <?php
                    $loop = new WP_Query( array( 'post_type' => 'videoreviews', 'posts_per_page' => 35) ); ?>  
                    <?php while ( $loop->have_posts() ) : $loop->the_post(); ?>

                        <div class="col-md-6">
                            <div class="video-box">
                                <?php the_field('embedded_video_reviews'); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
                        ...
                        <a href="javascript:;" target="_blank" class="read-more">
                            <div class="reviewBox">
