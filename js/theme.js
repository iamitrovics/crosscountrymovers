  ...
  jQuery(document).ready(function () {
    ...
    $(document).mouseup(function (e) {
      ...
      && $menu.has(e.target).length === 0) // ... nor a descendant of the container
        {
          $menu.removeClass('menu-active'); // $('.menu-overlay').removeClass("active-overlay");
        }
    });
    ...
    $(".services-accordion__in .faq-wrap > h3").on("click", function (e) {
      if ($(this).hasClass("active")) {
        $(this).removeClass("active");
        $(this).siblings(".services-accordion__in .faq-wrap .faq-content").slideUp(200);
      } else {
        $(".services-accordion__in .faq-wrap > h3").removeClass("active");
        $(this).addClass("active");
        $(".services-accordion__in .faq-wrap .faq-content").slideUp(200);
        $(this).siblings(".services-accordion__in .faq-wrap .faq-content").slideDown(200);
      }
